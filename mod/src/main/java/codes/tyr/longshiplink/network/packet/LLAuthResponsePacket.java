...
public class LLAuthResponsePacket {
    ...
    public static void send(@NotNull ServerPlayerEntity player, @NotNull String mid, @NotNull String subKey, @NotNull String pubKey, @NotNull String token, boolean renewal) {
